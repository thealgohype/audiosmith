      ...
      <div className="input-wrapper">
        ...
        <div className="icons-container">
          ...
          <div className="dropdown-container">
            <img src={tool} alt="Tool" className="input-icon" onClick={() => setShowDropdown(!showDropdown)} />
            {showDropdown && (
